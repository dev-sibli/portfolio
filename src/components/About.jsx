...
const About = () => {
	return (
		<div name="about" className="w-full h-screen bg-[#141E61] text-gray-300">
			<div className="flex flex-col justify-center items-center w-full h-full">
				...
				<div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
					<div className="sm:text-right text-4xl font-bold">
						<p>
							Hi. I'm Sibli Sadik, nice to meet you. Please take a look around.
						</p>
					</div>
					<div>
						<p>
							...
							MERN Stack Developer available at your fingertips?
						</p>
					</div>
				</div>
			</div>
